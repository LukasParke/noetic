...
export interface ProjectionPolicy {
   ...
   * exceeds this, the runtime emits a `context_pressure` framework event so an
   * agent (or the host app) can compact instead of letting the assembler
   * silently drop the oldest turns. Compaction itself stays explicit: record a
