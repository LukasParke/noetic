/**
 * End-to-end tests for context layers using a real LLM via OpenRouter.
 *
 * These tests require OPENROUTER_API_KEY to be set in the environment.
 * They exercise real model calls to verify the context layer system
...
import type { ExecutionContext } from '@noetic-tools/context';
import {
